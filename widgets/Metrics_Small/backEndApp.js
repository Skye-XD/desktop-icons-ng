...
class BackendApp extends Gio.Application {
    _init(params = {}) {
        super._init({
            application_id: params.applicationId ?? 'com.desktop.ding.widget.metrics',
    ...
    vfunc_startup() {
        ...
        // Keep process alive even without actions/windows.
        this.hold();
    ...
    async _readLoop() {
        ...
        this.error('backend read loop ended; stdin closed or read failed');
