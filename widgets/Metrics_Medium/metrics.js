...
class MetricsWidget{
 ...
 async start(){
  ...
  const scaleFor = v => {
   // Target ~60% fill: scale ~ v / 0.6. Floor to K so suffix shows even at 0.
   ...
   if (base >= 1e3) return {barScale: base, displayDiv: 1e3, suffix: 'K'};
   return {barScale: base, displayDiv: 1, suffix: ''};
  };
