...
userns privilges are viewed as a security concern by app-armor, and the profile for bwrap (the binary program) currently breaks bubblewrap functionality on Ubuntu. See the reasons this was done [here](https://ubuntu.com/blog/ubuntu-23-10-restricted-unprivileged-user-namespaces). This [wiki page](https://gitlab.com/apparmor/apparmor/-/wikis/unprivileged_userns_restriction) contains more details if anyone's interested.
