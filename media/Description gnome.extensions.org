...
* New - About pane if preferences page that shows the correct version of the extension and weblimks to gitlab website.
* Fix - Gnome shell and extension auto-move-windows creates a empty workspace to the right as it detects the DING window. This can lead to Unlimited Workspaces. Although this now works, extension smart-auto-move recommended for a better solution.
